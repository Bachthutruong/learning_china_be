...
exports.performCheckin = exports.getCheckinStatus = void 0;
...
const getCheckinStatus = async (req, res) => {
    try {
        ...
        const learnedTodayCount = await UserVocabulary_1.UserVocabulary.countDocuments({
...
const performCheckin = async (req, res) => {
    try {
        ...
        await user.save();
        // Level up check
        await (0, levelUtils_1.checkAndUpdateUserLevel)(String(user._id));
        return res.json({
