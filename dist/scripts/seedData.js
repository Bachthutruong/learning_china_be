...
async function seedData() {
    try {
        ...
        const createdTopics = await Topic_1.default.insertMany(topics);
        console.log(`Created ${createdTopics.length} topics`);
        // Seed Levels
        console.log('Seeding levels...');
        const createdLevels = await Level_1.default.insertMany(levels);
        ...
        const createdVocabularies = await Vocabulary_1.default.insertMany(vocabularies);
        console.log(`Created ${createdVocabularies.length} vocabularies`);
        // Seed Tests
        console.log('Seeding tests...');
        const createdTests = await Test_1.default.insertMany(tests);
        console.log(`Created ${createdTests.length} tests`);
        // Seed Proficiency Tests
        console.log('Seeding proficiency tests...');
        const createdProficiencyTests = await ProficiencyTest_1.default.insertMany(proficiencyTests);
        console.log(`Created ${createdProficiencyTests.length} proficiency tests`);
        // Seed Competitions
        console.log('Seeding competitions...');
        const createdCompetitions = await Competition_1.default.insertMany(competitions);
