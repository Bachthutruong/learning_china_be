...
exports.personalizedVocabularySuggestions = void 0;
exports.getPersonalizedVocabularySuggestions = getPersonalizedVocabularySuggestions;
const flow_1 = require("@genkit-ai/flow");
const zod_1 = require("zod");
const inputSchema = zod_1.z.object({
    topic: zod_1.z.string().describe('The topic for vocabulary suggestions'),
    keywords: zod_1.z.string().describe('Additional keywords for suggestions')
});
const outputSchema = zod_1.z.object({
    suggestedVocabulary: zod_1.z.array(zod_1.z.object({
        hanzi: zod_1.z.string(),
        pinyin: zod_1.z.string(),
...
exports.personalizedVocabularySuggestions = (0, flow_1.defineFlow)({
...
async function getPersonalizedVocabularySuggestions(input) {
    const suggestions = generateVocabularySuggestions(input.topic, input.keywords);
    return {
        suggestedVocabulary: suggestions
    };
}
function generateVocabularySuggestions(topic, keywords) {
    ...
    if (keywords && keywords.trim()) {
        const keywordSuggestions = vocabularyDatabase['Tùy chỉnh'].filter(vocab => vocab.meaning.toLowerCase().includes(keywords.toLowerCase()) ||
